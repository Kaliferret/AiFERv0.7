...
export default function Profile() {
  return (
    <PopShell title='Profile' subtitle='AiFER v0.7 placeholder screen'>
      <div style={ padding: 24, display: 'grid', gap: 16 }>
        <SectionHeader title='Profile' subtitle='This module was scaffolded to make the uploaded codebase releaseable.' right={<PopBadge>v0.7</PopBadge>} />
        <PopCard>
