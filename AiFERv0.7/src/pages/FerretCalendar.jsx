...
export default function FerretCalendar() {
  return (
    <PopShell title='FerretCalendar' subtitle='AiFER v0.7 placeholder screen'>
      <div style={ padding: 24, display: 'grid', gap: 16 }>
        <SectionHeader title='FerretCalendar' subtitle='This module was scaffolded to make the uploaded codebase releaseable.' right={<PopBadge>v0.7</PopBadge>} />
        <PopCard>
