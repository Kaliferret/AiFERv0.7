...
export default function FerretFitness() {
  return (
    <PopShell title='FerretFitness' subtitle='AiFER v0.7 placeholder screen'>
      <div style={ padding: 24, display: 'grid', gap: 16 }>
        <SectionHeader title='FerretFitness' subtitle='This module was scaffolded to make the uploaded codebase releaseable.' right={<PopBadge>v0.7</PopBadge>} />
        <PopCard>
